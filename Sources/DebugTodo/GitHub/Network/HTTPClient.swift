...
struct HTTPClient: Sendable {
    ...
    init(configuration: URLSessionConfiguration = .default) {
        ...
        let urlCache = URLCache(
            memoryCapacity: memoryCapacity, diskCapacity: diskCapacity, diskPath: nil)
    ...
    @discardableResult
    func send<Request: APIRequest>(for request: Request) async throws -> (
        ...
        case 200...299:
            do {
                let parsedData = try request.parseResponse(
                    from: data, httpURLResponse: httpResponse)
        ...
        case 300...399:
            throw NetworkError.redirectError(
                statusCode: httpResponse.statusCode, response: httpResponse, data: data)
        case 400:
        ...
        case 400...499:
            throw NetworkError.otherClientError(
                statusCode: httpResponse.statusCode, response: httpResponse, data: data)
        case 500:
